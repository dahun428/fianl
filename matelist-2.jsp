...
<body>
	...
	<div class="body">
		<div class="container">
			<div class="row">
				<div class="col-12  mt-4" style="border: 1px solid gray;"></div>
				<div class="col-12  mt-4" style="border: 1px solid gray;"></div>
					...
					<div class="item">
						<div class="item-right">
							...
							<div class="text-center">
								...
								<button class="btn btn-primary mt-2" style="width: 130px;">참가</button>
							</div>
							<div class="mt-3">
							</div>
							...
							<div class="row">
								<div class="col-12">
									...
									<div class="mt-5 text-muted	"
										...
										<i class="fas fa-flag"></i> 인원 <span class="ml-2">2</span> <span>/</span>
										<span>3</span>
									</div>
									...
									<div style="border-bottom: 1px solid gray;">
										<div class="text-muted">
											...
											<span>userid</span> 
											<button class="btn btn-primary btn-sm ml-5">미리보기</button>
										</div>
										<div>
										</div>
									</div>
	...
	<div class='music-card playing'>
		<div class='image'
			style="background-image: url('sample-images/sample-consert1.jpg');"></div>
		...
		<div class='info'>
			...
			<div class="row mt-4">
				<div class="col-12">
					...
					<small><span class="ml-2">개설</span> <span>4</span> <span>개</span>
					</small>
				</div>
				<div class="col-12">
